...
class Huffman
{
  ...
  private void addCode(int paramInt1, int paramInt2, byte paramByte)
  {
    ...
    while (paramByte > 8)
    {
      ...
      {
        if (localNode2.children[paramInt1] == null) {
          localNode2.children[paramInt1] = new Node();
        }
...
/* Location:              ~/okhttp3/internal/http2/Huffman.class
 *
 * Reversed by:           J
 */