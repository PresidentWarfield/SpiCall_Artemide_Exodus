...
public final class CipherSuite
{
  ...
  public static CipherSuite forJavaName(String paramString)
  {
    try
    {
      CipherSuite localCipherSuite1 = (CipherSuite)INSTANCES.get(paramString);
      CipherSuite localCipherSuite2 = localCipherSuite1;
      if (localCipherSuite1 == null)
      {
        localCipherSuite1 = (CipherSuite)INSTANCES.get(secondaryName(paramString));
        ...
        INSTANCES.put(paramString, localCipherSuite2);
      }
...
/* Location:              ~/okhttp3/CipherSuite.class
 *
 * Reversed by:           J
 */