  ...
  implements NestedScrollingParent, DecorContentParent
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int i = Math.max(0, this.mActionBarTop.getMeasuredWidth() + ((LayoutParams)localObject).leftMargin + ((LayoutParams)localObject).rightMargin);
    int j = Math.max(0, this.mActionBarTop.getMeasuredHeight() + ((LayoutParams)localObject).topMargin + ((LayoutParams)localObject).bottomMargin);
    ...
    int i1 = Math.max(i, this.mContent.getMeasuredWidth() + ((LayoutParams)localObject).leftMargin + ((LayoutParams)localObject).rightMargin);
    int m = Math.max(j, this.mContent.getMeasuredHeight() + ((LayoutParams)localObject).topMargin + ((LayoutParams)localObject).bottomMargin);
    ...
    setMeasuredDimension(View.resolveSizeAndState(Math.max(i1 + (n + j), getSuggestedMinimumWidth()), paramInt1, k), View.resolveSizeAndState(m, paramInt2, k << 16));
  }
