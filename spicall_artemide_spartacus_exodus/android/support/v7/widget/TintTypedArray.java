...
public class TintTypedArray
{
  ...
  public ColorStateList getColorStateList(int paramInt)
  {
    if (this.mWrapped.hasValue(paramInt))
    {
      ...
      if (i != 0)
      {
        ColorStateList localColorStateList = b.a(this.mContext, i);
  ...
  public Typeface getFont(int paramInt1, int paramInt2, TextView paramTextView)
  {
...
/* Location:              ~/android/support/v7/widget/TintTypedArray.class
 *
 * Reversed by:           J
 */