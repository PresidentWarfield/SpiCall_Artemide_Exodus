  ...
  implements MenuItemHoverListener
{
  ...
  public void onItemHoverEnter(h paramh, MenuItem paramMenuItem)
  {
    ...
    if (localMenuItemHoverListener != null) {
      localMenuItemHoverListener.onItemHoverEnter(paramh, paramMenuItem);
    }
  }
  ...
  public void onItemHoverExit(h paramh, MenuItem paramMenuItem)
  {
    MenuItemHoverListener localMenuItemHoverListener = this.mHoverListener;
    if (localMenuItemHoverListener != null) {
      localMenuItemHoverListener.onItemHoverExit(paramh, paramMenuItem);
    }
  }
      ...
      if (this.mHoverListener != null)
      {
        ...
        if (localMenuItem != localObject2)
        {
          ...
          if (localMenuItem != null) {
            this.mHoverListener.onItemHoverExit((h)localObject1, localMenuItem);
          }
          this.mHoveredMenuItem = ((MenuItem)localObject2);
          if (localObject2 != null) {
            this.mHoverListener.onItemHoverEnter((h)localObject1, (MenuItem)localObject2);
          }
        }
      }
...
/* Location:              ~/android/support/v7/widget/MenuPopupWindow.class
 *
 * Reversed by:           J
 */