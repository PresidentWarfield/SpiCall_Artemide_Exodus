  ...
  implements NestedScrollingChild, NestedScrollingParent
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    ((CircleImageView)localObject).layout(paramInt1 - paramInt4, paramInt3, paramInt1 + paramInt4, paramInt2 + paramInt3);
  }
...
/* Location:              ~/android/support/v4/widget/SwipeRefreshLayout.class
 *
 * Reversed by:           J
 */