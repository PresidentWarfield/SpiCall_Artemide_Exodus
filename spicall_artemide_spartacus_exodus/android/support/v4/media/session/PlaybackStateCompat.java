  ...
  implements Parcelable
{
  ...
  public static PlaybackStateCompat fromPlaybackState(Object paramObject)
  {
    ...
    {
      Object localObject1 = PlaybackStateCompatApi21.getCustomActions(paramObject);
      ...
      if (Build.VERSION.SDK_INT >= 22) {
        localObject1 = PlaybackStateCompatApi22.getExtras(paramObject);
      } else {
        localObject1 = null;
      }
      Object localObject2 = new PlaybackStateCompat(PlaybackStateCompatApi21.getState(paramObject), PlaybackStateCompatApi21.getPosition(paramObject), PlaybackStateCompatApi21.getBufferedPosition(paramObject), PlaybackStateCompatApi21.getPlaybackSpeed(paramObject), PlaybackStateCompatApi21.getActions(paramObject), 0, PlaybackStateCompatApi21.getErrorMessage(paramObject), PlaybackStateCompatApi21.getLastPositionUpdateTime(paramObject), (List)localObject2, PlaybackStateCompatApi21.getActiveQueueItemId(paramObject), (Bundle)localObject1);
  ...
  public Object getPlaybackState()
  {
    ...
    {
      Object localObject = this.mCustomActions;
      if (localObject != null)
      {
        localObject = new ArrayList(((List)localObject).size());
        Iterator localIterator = this.mCustomActions.iterator();
        while (localIterator.hasNext()) {
          ((List)localObject).add(((CustomAction)localIterator.next()).getCustomAction());
        }
      }
      else
      {
...
/* Location:              ~/android/support/v4/media/session/PlaybackStateCompat.class
 *
 * Reversed by:           J
 */